...
const GPIO_InitTypeDef TX3_pin = { GPIO_Pin_10,  GPIO_Speed_50MHz, GPIO_Mode_AF_PP };
const GPIO_InitTypeDef RX3_pin = { GPIO_Pin_11,  GPIO_Speed_50MHz, GPIO_Mode_IN_FLOATING };
...
USB_USART_Data_t USB_USART1_Data = { 0, 0, ENDP2, EP2_OUT, ENDP2, EP2_IN,
	USART1,
...
USB_USART_Data_t USB_USART2_Data = { 0, 0, ENDP4, EP4_OUT, ENDP4, EP4_IN,
	USART2,
...
USB_USART_Data_t USB_USART3_Data = { 0, 0, ENDP6, EP6_OUT, ENDP6, EP6_IN,
	USART3,
	GPIOA, &TX3_pin, &RX3_pin,
