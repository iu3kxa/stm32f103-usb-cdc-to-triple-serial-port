...
#define EP_NUM                          (7)
	...
	*/
	...
	#define ENDP1_TXADDR        (0x110)	//data
	#define ENDP2_TXADDR        (0x120)	//control
	#define ENDP2_RXADDR        (0x140) //data
	
	#define ENDP3_TXADDR        (0x160)	//data
	#define ENDP4_TXADDR        (0x170)	//control
	// 1FF - 40 + 1
	#define ENDP4_RXADDR        (0x190)	//data
	
	
	#define ENDP5_TXADDR        (0x1B0)	//data
	#define ENDP6_TXADDR        (0x1C0)	//control
	#define ENDP6_RXADDR        (0x1E0)	//data
